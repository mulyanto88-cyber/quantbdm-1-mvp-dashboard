...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/ksei1persen',    label: 'KSEI >1% Ownership Intelligence',     icon: icons.eye,        badge: 'PRO' },
      ...
      <aside
        ...
        <div className="flex items-center h-[52px] px-3.5 border-b border-border flex-shrink-0">
          <div className="w-7 h-7 rounded-lg flex items-center justify-center font-bold text-xs"
            style={{ background: 'linear-gradient(135deg, #e7b733, #c49a1a)', color: '#0a122c', fontFamily: 'monospace' }}>B</div>
          {(expanded || mobileOpen) && (
